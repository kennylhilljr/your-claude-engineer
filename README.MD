...
> **Note:** The `AgentHarnessDiagram.png` image shows the current architecture with all agents, Linear support, PR review, multi-AI providers, and defense-in-depth security.
