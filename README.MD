...
> **Note:** The `AgentHarnessDiagram.png` image shows the current architecture with all 11 agents, Jira/Linear support, PR review, multi-AI providers, and defense-in-depth security.
